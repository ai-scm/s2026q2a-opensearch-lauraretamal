...
| Aspecto | Sample Logs | Productos |
|---------|------------|-----------|
| Documentos | 2,780 | 5 |
| Período | 2020-2024 | 2026 |
| Caso de uso | Análisis de logs web | Gestión de inventario |
| Campos | 8+ | 5 |
| Tipo de datos | Temporal, geográfico | Catálogo de productos |

---

## Verificación de integridad

**Verificar índices cargados:**
```
GET _cat/indices?v
```
...
green  open   productos                                  xxxxx                  1   0   5
green  open   opensearch_dashboards_sample_data_logs     xxxxx                  1   1   2780
```
